...
/**
    Flattened ChildMintableERC20.sol
    Taken from: https://github.com/maticnetwork/pos-portal/blob/master/flat/ChildMintableERC20.sol
    Meant to be deployed on the child chain and used for bridgin between Matic and Ethereum.
    Modified to support solc v0.8.0.
 */
